    ...
    function controller($location, $scope, $http, $timeout, $mdSidenav, $mdDialog) {
        ...
        function dataSender() {
            ...
            for (var i = 0; i < k.length; i++) {
                if (!angular.equals(vm.data[k[i]], oldData[k[i]])) {
        ...
        vm.totals = [
            ...
            { title: 'Δείκτης Μικτού Κέρδους(%)', hint: 19, values: [], formula: function (i, j) { return vm.data.totals[j].values[i] = (vm.data.totals[0].values[i] + vm.data.totals[4].values[i]) / vm.data.totals[0].values[i] } },
            { title: 'Κόστος Πωληθέντων(%)', hint: 20, values: [], formula: function (i, j) { return vm.data.totals[j].values[i] = vm.data.totals[4].values[i] / vm.data.totals[0].values[i] } },
            { title: 'Δείκτης ταχύτητας κυκλοφορίας ενεργητικού', hint: 21, values: [], formula: function (i, j) { return vm.data.totals[j].values[i] = vm.data.totals[0].values[i] / vm.data.totals[1].values[i] } },
            { title: 'Δείκτης γενικής ρευστότητας:', hint: 22, values: [], formula: function (i, j) { return vm.data.totals[j].values[i] = vm.data.totals[10].values[i] / vm.data.totals[9].values[i] } },
            { title: 'Δείκτης ταχύτητας είσπραξης απαιτήσεων', hint: 23, values: [], formula: function (i, j) { return vm.data.totals[j].values[i] = vm.data.totals[0].values[i] / vm.data.totals[7].values[i] } },
            { title: 'Δείκτης οικονομικής μοχλεύσεως', values: [], hint: 24, formula: function (i, j) { return vm.data.totals[j].values[i] = vm.data.totals[2].values[1] / vm.data.totals[6].values[i] } },
            ...
            { title: 'Δείκτης αποδοτικότητας ενεργητικού', hint: 26, values: [], formula: function (i, j) { return vm.data.totals[j].values[i] = (vm.data.totals[2].values[i] / vm.data.totals[1].values[i]) * 100 } }
        ];
        if (vm.data.totals) {
